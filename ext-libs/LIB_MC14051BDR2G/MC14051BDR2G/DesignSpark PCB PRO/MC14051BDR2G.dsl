SamacSys ECAD Model
225153/1622586/2.50/16/2/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOIC127P600X175-16N" (originalName "SOIC127P600X175-16N")
		...
		(layerContents (layerNumRef 30)
			(line (pt -3.725 5.2) (pt 3.725 5.2) (width 0.05))
		)
		(layerContents (layerNumRef 30)
			(line (pt 3.725 5.2) (pt 3.725 -5.2) (width 0.05))
		)
	...
	(symbolDef "MC14051BDR2G" (originalName "MC14051BDR2G")
	...
	(compDef "MC14051BDR2G" (originalName "MC14051BDR2G") (compHeader (numPins 16) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "X4") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "X6") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "X") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "X7") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "X5") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "15" (pinName "X2") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "14" (pinName "X1") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "13" (pinName "X0") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "12" (pinName "X3") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MC14051BDR2G"))
		...
		(attr "Mouser Part Number" "863-MC14051BDR2G")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi/MC14051BDR2G?qs=g2rIOKKlpoZiRT%252Bz5I%252B8eg%3D%3D")
		(attr "Manufacturer_Name" "onsemi")
		(attr "Manufacturer_Part_Number" "MC14051BDR2G")
		(attr "Description" "Low-noise - 12 nV/sqrt.Cycle, f <= 1.0 kHz Typical; For 4PDT Switch, See MC14551B; Switch Function is Break Before Make; Supply Voltage Range = 3.0 Vdc to 18 Vdc; Analog Voltage Range (VDD - VEE) = 3.0 to 18 V Note: VEE must be <= VSS; Triple Diode Protection on Control Inputs; For Lower RON, Use the HC4051, HC4052, or HC4053 High-Speed CMOS Devices; Linearized Transfer Characteristics; Pin-for-Pin Replacement for CD4051, CD4052, and CD4053; Pb-Free Packages are Available*")
		(attr "Datasheet Link" "https://www.onsemi.com/pub/Collateral/MC14051B-D.PDF")
		(attr "Height" "1.75 mm")
	)
